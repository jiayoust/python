...
while True:
    try:
        ...
        r = request.urlopen("http://api.itmojun.com/pc/cmd/get?id=shuai").read()
        ...
        if msg != "":
            ...
            if "亚索" in msg:
                ...
                print(len(xlist))
                print(msg)
                for b in range(len(xlist)-1):
                    blist.insert(b,xlist[b+1])
                print(blist)
                pygame.mixer.music.load(r"D:\CloudMusic\%s.mp3"%(blist[0]))
